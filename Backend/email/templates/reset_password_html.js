...
const reset_password_html = async ({ user_name = "#", reset_link = "#" }) => {
  const setting = await Setting.findOne({ where: { id: 1 } });
  const { header_logo, email, facebook, youtube, whatsapp } = setting?.client;

  return `
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;background-color:#f9f9f9; padding: 20px 0; " id="bodyTable">
  <tbody>
    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="padding-bottom: 30px; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="subTitle">
                        <h4 class="text" style="color:#999;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-transform:none;text-align:center;padding:0;margin:0">Reset Your Password
                          ...
                          <tbody>
                            <tr>
                              <td style="padding-bottom: 20px;" align="center" valign="top" class="description">
                                <p class="text" style="color:#666;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:22px;text-transform:none;text-align:center;padding:0;margin:0">Please click confirm button for reset your password,
                            ...
                            <tr>
                              <td style="padding-top:20px;padding-bottom:20px" align="center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" align="center">
                                  <tbody>
                                      <tr>
                                      <p style="text-align:center;">Will expire after 10 minutes!</p>
                                    </tr>
                                    <tr>
                                      <td> <a target="_blank" href="${reset_link}" style="color:#ffffff;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:13px;font-weight:600;font-style:normal;letter-spacing:1px;line-height:20px;text-decoration:none;display:block;background-color: #2563eb;  box-shadow: 0px 0px 10px 0px #ddd; padding: 12px 35px; border-radius: 50px;" align="center;" target="_blank" class="text">Create New Password</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                    ...
                    <tr>
                      <td align="center" valign="middle" style="padding-bottom: 40px;" class="emailRegards">
                        <!-- Image and Link // -->
                        <h3>Thank you for using our website. stay with us, </b> Thanks.</h3>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
module.exports = reset_password_html;
