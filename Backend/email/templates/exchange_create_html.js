...
const exchange_create_html = async ({
  user_name = "#",
  order_id = "",
  exchange_rate = "",
  sent_wallet = "",
                              ...
                              <td style="padding-top:20px;padding-bottom:20px" align="center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" align="center">
                                  <tbody>
                                    <tr>
                                      <td>
                                        <h3 style="color:#0961a9; padding:6px; text-align:center;">Your Exchange has been created!</h3>
                                    </td>
                                    </tr>
                                  </tbody>
                                </table>
...
module.exports = exchange_create_html;
