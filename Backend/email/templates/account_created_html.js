...
const account_created_html = async (user_name = "sagar") => {
                            ...
                            <tr>
                              <td style="padding-top:20px;padding-bottom:20px" align="center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" align="center">
                                  <tbody>
                                    <tr>
                                      <td> <a target="_blank" href="#" style="color:#ffffff;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:600;font-style:normal;letter-spacing:1px;line-height:20px;text-decoration:none;display:block;background-color: #09a91c;  box-shadow: 0px 0px 10px 0px #ddd; padding: 12px 35px; border-radius: 50px; text-align: center;" align="center;" target="_blank" class="text">Wellcome!</a>
                                        <h3 style="color:#09a91c; padding:6px; text-align:center;">Your account successfully created!</h3>
                                        <h4>Now you can exchange everything from our site.</h4>
                                    </td>
                                    </tr>
                                  </tbody>
                                </table>
...
module.exports = account_created_html;
